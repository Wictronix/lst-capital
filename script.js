...
document.addEventListener('DOMContentLoaded', function() {
    const elementsToObserve = document.querySelectorAll(
        '.about-card, .service-card, .performance-card, .team-member, .hero-stats, .contact-content'
    );
...
document.addEventListener('DOMContentLoaded', function() {
    const cards = document.querySelectorAll('.about-card, .service-card, .performance-card, .team-member');
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (currentLocation) {
        const targetLink = document.querySelector(`a[href="${currentLocation}"]`);
        if (targetLink) {
